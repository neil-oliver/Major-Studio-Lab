...
console.log("The length of names variable is: " + names.length)
console.log("The length of URLs variable is: " + URLs.length)
console.log("The length of years variable is: " + names.length)
...
addAMuseum(museums2,"The MET", "www.met.org", 2019);

console.log('updated museums list', museums2);